...
public class ReservationMobileController {
        ...
        public ResponseEntity<CreateReservationWithPaymentConfirmMobileResponseV1> createReservationWithPaymentConfirm(
                ...
                reservationMobileService
                                .createReservationWithPaymentConfirm(
                                                createReservationWithPaymentConfirmMobileRequestV1);
                return ResponseEntity.ok(
                                CreateReservationWithPaymentConfirmMobileResponseV1.builder().success(true).build());
        }

        @PostMapping("/v1/mobile/reservation/validate")
        public ResponseEntity<Void> validateReservationBeforePayment(final @MemberId Long memberId,
                        final @RequestBody ValidationReservationBeforePaymentMobileRequestV1 validationReservationBeforePaymentMobileRequestV1) {
                validationReservationBeforePaymentMobileRequestV1.setMemberId(memberId);
                reservationMobileService
                                .validateReservationBeforePayment(validationReservationBeforePaymentMobileRequestV1);
                return ResponseEntity.ok().build();
        }

        @PutMapping("/v1/mobile/reservation/cancel")
        public ResponseEntity<CancelReservationAdminResponseV1> cancelReservation(@MemberId Long memberId,
                        @RequestBody CancelReservationMobileRequestV1 cancelReservationMobileRequestV1) {
        ...
        public ResponseEntity<Void> refundReservation(@MemberId Long memberId,
                        @RequestBody RefundReservationMobileRequestV1 refundReservationMobileRequestV1) {
                reservationMobileService.refundReservation(memberId, refundReservationMobileRequestV1);
                return ResponseEntity.ok().build();
        }

        @PutMapping("/v1/mobile/reservation/update/status/teacher")
        public ResponseEntity<Void> updateReservationStatus(@MemberId Long memberId,
                        @RequestBody UpdateReservationStatusMobileRequestV1 request) {
                reservationMobileService.updateReservationStatus(memberId, request);
                return ResponseEntity.ok().build();
        }
        ...
        public ResponseEntity<List<GetReservationMobileResponse>> getReservationList(@MemberId Long memberId) {
                final List<ReservationMobileDto> reservationMobileDtoList = reservationMobileService
                                .getReservationList(memberId);
                final List<GetReservationMobileResponse> getReservationMobileResponseList = reservationMobileDtoList
                                ...
                                .map(reservationMobileDto -> GetReservationMobileResponse.builder()
                                                ...
                                                .lectureImageUrl(reservationMobileDto.getWellnessLectureDto()
                                                                .getLectureImageUrlList().get(0))
                                                .lectureTypeName(
                                                                reservationMobileDto.getWellnessLectureTypeDto().name())
                                                .lectureTypeDescription(reservationMobileDto.getWellnessLectureTypeDto()
                                                                .description())
                                                ...
                                                .lectureStartDateTime(reservationMobileDto.getWellnessLectureDto()
                                                                .getStartDateTime())
                                                .lectureEndDateTime(reservationMobileDto.getWellnessLectureDto()
                                                                .getEndDateTime())
        ...
        public ResponseEntity<List<GetReservationCheckInMobileResponse>> getReservationCheckInList(
                        @MemberId Long memberId) {
                final List<ReservationMobileDto> reservationMobileDtoList = reservationMobileService
                                .getReservationCheckInList(memberId);
                final List<GetReservationCheckInMobileResponse> getReservationMobileResponseList = reservationMobileDtoList
                                ...
                                .map(reservationMobileDto -> GetReservationCheckInMobileResponse.builder()
                                                ...
                                                .lectureRoom(reservationMobileDto.getWellnessLectureDto().getRoom())
                                                .centerName(reservationMobileDto.getCenterDto().getName())
                                                .lectureReviewId(reservationMobileDto
                                                                .getMyWellnessLectureReviewDto() != null
                                                                                ? reservationMobileDto
                                                                                                .getMyWellnessLectureReviewDto()
                                                                                                .getId()
                                                                                : null)
                                                .rating(WellnessLectureReviewUtils
                                                                .calculateAverageRating(reservationMobileDto
                                                                                .getWellnessLectureReviewDtoList()))
                                                .reviewCnt(reservationMobileDto
                                                                .getWellnessLectureReviewDtoList() != null
                                                                                ? reservationMobileDto
                                                                                                .getWellnessLectureReviewDtoList()
                                                                                                .size()
                                                                                : null)
