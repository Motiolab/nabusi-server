...
public class WellnessLectureAdminServiceImpl implements WellnessLectureAdminService {
        ...
        public void createWellnessLectureListWithWellnessClass(
                ...
                final WellnessClassDto wellnessClassDto = WellnessClassDto.builder()
                                ...
                                .maxReservationCnt(createWellnessLectureListWithWellnessClassAdminRequestV1
                                ...
                                .classImageUrlList(createWellnessLectureListWithWellnessClassAdminRequestV1
                                                .getClassImageUrlList())
                                .teacherId(createWellnessLectureListWithWellnessClassAdminRequestV1.getTeacherId())
                                .wellnessLectureTypeId(
                                                createWellnessLectureListWithWellnessClassAdminRequestV1
                ...
                final List<TimeWithDay> timeWithDayList = createWellnessLectureListWithWellnessClassAdminRequestV1
                                ...
                                .map(timeRangeWithDay -> TimeWithDay.builder()
                                                .startTime(timeRangeWithDay.getStartTime())
                                                .endTime(timeRangeWithDay.getEndTime())
                                                .dayOfWeek(timeRangeWithDay.getDayOfWeek()).build())
                                .toList();
                final RangeZoneDateTime rangeZoneDateTime = RangeZoneDateTime.builder()
                                .startDateTime(createWellnessLectureListWithWellnessClassAdminRequestV1
                                                .getStartDateTime())
                                .endDateTime(createWellnessLectureListWithWellnessClassAdminRequestV1.getEndDateTime())
                                .build();
                ...
                final List<WellnessLectureDto> wellnessLectureEntityList = calcDateListResponseList.stream()
                                .map(calcDateListResponse -> WellnessLectureDto.builder()
                                                .name(createWellnessLectureListWithWellnessClassAdminRequestV1
                                                                .getName())
                                                .description(createWellnessLectureListWithWellnessClassAdminRequestV1
                                                                .getDescription())
                                                .centerId(createWellnessLectureListWithWellnessClassAdminRequestV1
                                                                .getCenterId())
                                                .maxReservationCnt(
                                                                createWellnessLectureListWithWellnessClassAdminRequestV1
                                                                                .getMaxReservationCnt())
                                                .registerId(createWellnessLectureListWithWellnessClassAdminRequestV1
                                                                .getRegistrantId())
                                                .room(createWellnessLectureListWithWellnessClassAdminRequestV1
                                                                .getRoom())
                                                .lectureImageUrlList(
                                                                createWellnessLectureListWithWellnessClassAdminRequestV1
                                                                                .getClassImageUrlList())
                                                .price(createWellnessLectureListWithWellnessClassAdminRequestV1
                                                                .getPrice())
                                                .wellnessClassId(
                                                                createWellnessLectureListWithWellnessClassAdminRequestV1
                                                                                .getWellnessClassId())
                                                .teacherId(createWellnessLectureListWithWellnessClassAdminRequestV1
                                                                .getTeacherId())
                                                .wellnessLectureTypeId(
                                                                createWellnessLectureListWithWellnessClassAdminRequestV1
                                                                                .getWellnessLectureTypeId())
        ...
        public List<WellnessLectureAdminDto> getWellnessLectureListByStartDate(Long centerId, ZonedDateTime startDate) {
                ...
                final List<WellnessLectureDto> wellnessLectureDtoList = wellnessLectureService
                                .getAllByCenterIdAndStartDateTimeBetweenAndIsDeleteFalse(centerId, startDateTime,
                                                endDateTime);
                ...
                return wellnessLectureDtoList.stream().map(wellnessLectureDto -> WellnessLectureAdminDto.builder()
                                ...
                                .teacherDto(teacherDtoList.stream()
                                                .filter(teacherDto -> teacherDto
                                                                .getId().equals(wellnessLectureDto.getTeacherId()))
                                                .findFirst()
                                                .orElseThrow(() -> new RuntimeException(
                                                                "Error: Teacher is not found. id: "
                                ...
                                .wellnessLectureTypeDto(wellnessLectureTypeDtoList.stream()
                                                ...
                                                .findFirst()
                                                .orElseThrow(() -> new RuntimeException(
                                                                "Error: WellnessLectureType is not found. id: "
                                                                                + wellnessLectureDto
                                                                                                .getWellnessLectureTypeId())))
                                .build())
                                .toList();
        ...
        public WellnessLectureAdminDto getWellnessLectureDetailById(Long id) {
                ...
                if (wellnessLectureTypeDto == null) {
                        throw new NotFoundException(WellnessLectureTypeDto.class,
                ...
                final List<WellnessLectureAdminDto.WellnessTicketExtension> wellnessTicketExtensionList = wellnessTicketManagementDtoList
                                .stream()
                                .map(wellnessTicketManagementDto -> WellnessLectureAdminDto.WellnessTicketExtension
                                                .builder()
                                                ...
                                                .wellnessTicketDto(
                                                                wellnessTicketDtoList.stream()
                                                                                .filter(wellnessTicketDto -> wellnessTicketDto
                                                                                                .getId()
                                                                                                .equals(wellnessTicketManagementDto
                                                                                                                .getWellnessTicketId()))
                                                                                .findFirst()
                                                                                .orElseThrow(() -> new NotFoundException(
                                                                                                WellnessTicketDto.class,
                                                                                                wellnessTicketManagementDto
                                                                                                                .getWellnessTicketId())))
                                                .build())
                                .toList();
        ...
        public void deleteWellnessLectureById(Long id, Boolean isSendNoti) {
                final List<ReservationDto> reservationDtoList = reservationService.getAllByWellnessLectureId(id);
                ...
                if (hasActiveReservation) {
                        throw new RuntimeException("Error: Cannot delete lecture with active reservations.");
                }
        ...
        @Override
        public void deleteWellnessLectureListById(List<Long> idList) {
                final List<ReservationDto> reservationDtoList = reservationService
                                .getAllByWellnessLectureIdList(idList);
                final boolean hasActiveReservation = reservationDtoList.stream()
                                .anyMatch(reservationDto -> !List.of(
                                                ReservationStatus.MEMBER_CANCELED_RESERVATION,
                                                ReservationStatus.MEMBER_CANCELED_RESERVATION_REFUND,
                ...
                if (hasActiveReservation) {
                        throw new RuntimeException("Error: Cannot delete lectures with active reservations.");
                }

                idList.forEach(wellnessLectureService::delete);
        }
        ...
        public void updateWellnessLecture(UpdateWellnessLectureAdminRequestV1 updateWellnessLectureAdminRequestV1) {
                final WellnessLectureDto wellnessLectureDto = WellnessLectureDto.builder()
                                ...
                                .wellnessTicketManagementIdList(
                                                updateWellnessLectureAdminRequestV1.getWellnessTicketManagementIdList())
                                .build();
        ...
        @Override
        public void updateWellnessLectureList(
                        UpdateWellnessLectureListAdminRequestV1 updateWellnessLectureListAdminRequestV1) {
                final List<WellnessLectureDto> existingLectureList = wellnessLectureService
                                .getAllByIdList(updateWellnessLectureListAdminRequestV1.getIdList());

                existingLectureList.forEach(existingLecture -> {
                        if (updateWellnessLectureListAdminRequestV1.getName() != null)
                                existingLecture.setName(updateWellnessLectureListAdminRequestV1.getName());
                        if (updateWellnessLectureListAdminRequestV1.getDescription() != null)
                                existingLecture.setDescription(
                                                updateWellnessLectureListAdminRequestV1.getDescription());
                        if (updateWellnessLectureListAdminRequestV1.getCenterId() != null)
                                existingLecture.setCenterId(updateWellnessLectureListAdminRequestV1.getCenterId());
                        if (updateWellnessLectureListAdminRequestV1.getMaxReservationCnt() != null)
                                existingLecture.setMaxReservationCnt(
                                                updateWellnessLectureListAdminRequestV1.getMaxReservationCnt());
                        if (updateWellnessLectureListAdminRequestV1.getRoom() != null)
                                existingLecture.setRoom(updateWellnessLectureListAdminRequestV1.getRoom());
                        if (updateWellnessLectureListAdminRequestV1.getLectureImageUrlList() != null)
                                existingLecture.setLectureImageUrlList(
                                                updateWellnessLectureListAdminRequestV1.getLectureImageUrlList());
                        if (updateWellnessLectureListAdminRequestV1.getPrice() != null)
                                existingLecture.setPrice(updateWellnessLectureListAdminRequestV1.getPrice());
                        if (updateWellnessLectureListAdminRequestV1.getTeacherId() != null)
                                existingLecture.setTeacherId(updateWellnessLectureListAdminRequestV1.getTeacherId());
                        if (updateWellnessLectureListAdminRequestV1.getWellnessLectureTypeId() != null)
                                existingLecture.setWellnessLectureTypeId(
                                                updateWellnessLectureListAdminRequestV1.getWellnessLectureTypeId());
                        if (updateWellnessLectureListAdminRequestV1.getWellnessTicketManagementIdList() != null)
                                existingLecture.setWellnessTicketManagementIdList(
                                                updateWellnessLectureListAdminRequestV1
                                                                .getWellnessTicketManagementIdList());

                        wellnessLectureService.update(existingLecture);
                });
        }
}
